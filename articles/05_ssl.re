...
単に「SSL証明書」という略称で呼んだ場合は、「SSLサーバ証明書」のことを指すことがほとんどです。本著でもSSLサーバ証明書のことを指して、SSL証明書という言葉を使用しています。
...
「はじめに」に書いたとおり、新しい技術を学ぶとき、私たちの理解度は「分かった！」「分かってなかった…」という上下をくり返しながら、ゆるやかに上がっていくものです@<fn>{heavy}。本著を通してSSL/TLSを学び、最初の「分かった」まで辿りつけましたでしょうか？

//footnote[heavy][筆者も本著を書きながら、ずっと「SSL/TLSわかったー！」「私はSSL/TLSについて多大な勘違いをしていたいのでは…？」「いや、SSL/TLSわかってきたかも」「もうだめだ、SSL/TLSのことは何一つわからない」「わか、わかった？わかっ…あ、いや、わかっ…？」という上下をくり返しました]

最初の一歩は、小さな一歩です。でもとても素晴らしい一歩です。本著は初心者が挫折せずに最初の「分かった」へ辿りつけるところを目指したので、省略した部分もかなり多く、説明は概略の範囲にとどまっています。本著を読み終えて、もっとSSL/TLSについて知りたくなったら、次の本をお勧めします。
