...
2020年2月現在、Oracle Cloudの［日本東部(東京)］のリージョンは人気が高く、Always Free向けのリソースが不足していてサーバが立てられない、という事態がしばしば起きています。［米国東部(アッシュバーン)］をホーム・リージョンにすれば、このリソース不足は回避できますので、Always Freeを確実に使いたい方は［米国東部(アッシュバーン)］を選択してください。本著ではAlways Free向けのリソースが不足していた場合は、無償クレジットを使用してサーバを立てますので、［日本東部(東京)］を選択して問題ありません。
