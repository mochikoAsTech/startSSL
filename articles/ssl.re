...
かつては、HTTPSにすると、暗号化と復号のオーバーヘッドのためウェブサイトが遅くなるというのが常識でした。しかし、サーバ側、クライアント側ともにCPUの性能が向上したことで、2020年現在、もはやオーバーヘッドは重要視するほどではなくなっています。@<fn>{sslAccelerator}
...
それでは1つ目の役割、「⁠ウェブサイトで送受信する情報を暗号化すること」をから、詳しく説明していきます。
