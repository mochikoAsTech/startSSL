...
Googleが2014年ごろからさかんに提唱している「HTTPS everywhere」（直訳すると「どこでもHTTPS」）のもと、ウェブサイトの評価基準は「HTTPは普通、HTTPSにすれば安心」から、「HTTPは危険、HTTPSが普通」に変わってきました。ますますSSLと関わる機会が増えてきて、心のどこかで「SSL、ちゃんと分かりたいなぁ…」と思っている。本著はそんな人のための一冊です。
