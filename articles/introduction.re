...
Googleが2014年ごろからさかんに提唱している「HTTPS everywhere」（直訳すると「どこでもHTTPS」）のもと、ウェブサイトの評価基準は「HTTPで100点、HTTPSにするとさらに加点」から、「HTTPSで100点、できていなければ減点」に変わってきました。ますますSSLと関わる機会が増えてきて、心のどこかで「SSL、ちゃんと分かりたいなぁ…」と思っている。本著はそんな人のための一冊です。
