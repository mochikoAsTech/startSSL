...
SSLは、エンジニアのごく身近なところにあります。例えば「サイトをフルSSL化する」「SSL証明書を更新する」のような形で、誰しも一度はSSLと関わりをもったことがあるのではないでしょうか。しかし関わる機会が多い割に、「ちゃんと分かっているか」と言われるとちょっと自信がない、そんなエンジニアは筆者を含め、きっと一定数いると思っていました。

Googleが2014年ごろからさかんに提唱している「HTTPS everywhere」（直訳すると「すべてをHTTPSで」）のもと、ウェブサイトの基準は、従来の「HTTPは普通、HTTPSにすれば安心」から、「HTTPは危険、HTTPSが普通」へと変わってきました。ますますSSLと関わる機会が増えてきて、心のどこかで「SSL、ちゃんと分かりたいなぁ…」と思っている。本書はそんな人のための一冊です。
...
DNS本、AWS本、そしてSSL本の『はじめようシリーズ3部作』は、「サーバやインフラは怖いものではなくすごく楽しいものなんだよ」ということを、かつての私のようなインフラ初心者へ伝えたくて書いたシリーズです。
