...
Oracle Cloudは名前のとおりオラクルがやっているクラウドですが、そもそもクラウドがなんだか分からないといまいちピンと来ないかもしれません。あなたが「ウェブサイトを公開したいなぁ…だからサーバが必要だ！」と思ったとき、従量課金で、すぐに使えて、性能や台数の増減も簡単にできるのがクラウドです。

Oracle Cloudなら、ブラウザでぽちぽちとスペックを選んでいくだけで、すぐにサーバが立てられます。
